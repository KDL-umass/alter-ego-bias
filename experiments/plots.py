...
def facebook_total_plot():
    ...
    for l2 in lambda2.keys():
        for j in range(10, 11, 10):
            ...
            worst_handle = synthetic_plot_dfs(dom_dfs, ax[lambda2[l2]], "blue", "solid")
            rand_handle = synthetic_plot_dfs(rand_dfs, ax[lambda2[l2]], "blue", "dashed")
            ...
            ax[lambda2[l2]].set_ylabel("\u03BB2="+l2,rotation=-90,labelpad=15)
