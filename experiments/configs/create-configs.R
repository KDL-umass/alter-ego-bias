...
create.configurations <- function(base.dir= "./experiments/configs/") {
  ...
  write.csv(exp1, file.path(base.dir, "all_graph_configurations.csv"))
...
create.graph.inf.configurations <- function(base.dir= "./experiments/configs/") {
  sizes <- c(500)
...
create.fb.configurations <- function(base.dir= "./experiments/configs/") {
